    ...
    var navBar = {
        ...
        Transmembrane: {
            ...
            items: [{
                    'Export': [{
                        name: 'htmExport',
                        text: "Download PHDhtm Raw Data File",
                        func: "exportMethod",
                        params: ["phdPred"]
                    }, {
                        name: 'jsonExport',
                        text: "Download PHDhtm in JSON format",
                        func: "exportJSON",
                        params: ['PHDhtm']
                    }, {
                        name: 'tmsegExport',
                        text: "Download TMSEG Raw Data File",
                        func: "exportMethod",
                        params: ["tmseg"]
                    }, {
                        name: 'TMSEGjsonExport',
                        text: "Download TMSEG in JSON format",
                        func: "exportJSON",
                        params: ['tmseg']
                    }]
                }
